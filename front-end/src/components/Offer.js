              ...
              <div className="card  w-100 d-flex">
                ...
                <div className="card-body cardBody1 ">
                  ...
                  <p className="card-text">
                    "Green Clean: Safe, sustainable, spotless. Your home, our
                    planet-friendly touch."
                  </p>
            ...
            <div className="col-lg-6 ">
              <div className="card  w-100 ">
                ...
                <div className="card-body ">
                  ...
                  <p className="card-text">
                    "Each clean, done with careful attention, leaves your space
                    looking pristine and beautiful."{" "}
                  </p>

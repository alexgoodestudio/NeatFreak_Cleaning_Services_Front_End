            ...
            <div className="col-lg-4 mt-3 mb-4">
              ...
              <div className="card">
                ...
                <ul class="list-group list-group-flush">
                  <li class="list-group-item">One Time Clean</li>
                  <li class="list-group-item">Moving In/ Moving Out</li>
                  <li class="list-group-item">Recurring Service</li>
                </ul>
              </div>
            </div>
            </div>
                ...
                <div className="col-lg-4 d-flex">
                  <div className="card  w-100 ">
                    ...
                    <div className="card-body ">
                      ...
                      <p className="card-text">
                      Comprehensive cleaning for hassle-free moving, ensuring your new or old space is immaculate.
                      </p>
